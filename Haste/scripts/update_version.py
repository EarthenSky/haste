...
def main():
  ...
  plistpath = scriptpath + "/resources/Haste-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Haste-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Haste-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Haste-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Haste-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Haste.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Haste.iss",inplace=1):
