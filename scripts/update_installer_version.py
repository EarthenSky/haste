...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Haste Demo Installer\n"
      else:
        line="OutputBaseFilename=Haste Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Haste Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Haste installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Haste Demo installer\n"
     else:
       line="SetupWindowTitle=Haste installer\n"
